...
{ 
  ...
  z[1] <- z_0
  u[1] <- ln.x[1] - xi - delta * ln.sigma2[1] - nu1 * z[1] - nu2 * (z[1] ^ 2 - 1) 
  
  for(t in 2:n)
  {
    # РЎР‚Р ВµР С”РЎС“РЎР‚РЎРѓР С‘Р Р†Р Р…РЎвЂ№Р Вµ РЎР‚Р В°РЎРѓРЎвЂЎР ВµРЎвЂљРЎвЂ№
    ln.sigma2[t] <- omega + alpha * ln.x[t - 1] + beta * ln.sigma2[t - 1]
